...
|----------|-----------|:-----------:|:--------------:|:------------:|:-------------:|:----:|
| Intel Xeon @ 2.10GHz | [PyTorch 2.11.0+cu130](https://github.com/pytorch/pytorch/releases/tag/v2.11.0) (CPU) | 56.43 | **682** | **1540** | **810** | 11.80 |
| | [ONNX Runtime 1.24.4](https://github.com/microsoft/onnxruntime) (CPU) | **35.98** | 178 | — | — | 11.80 |
...
Candle and Meganeura use different weight init (DIFFERENT MODEL) — outputs don't match PyTorch.
